import{vy as X,F_ as Z,F$ as ee,EB as te,Ez as ie,G0 as re,G1 as ae,EG as o,FT as se,Fd as oe,FS as ne,EF as z,G2 as ce,G3 as le,EC as pe,EE as de,EH as he,FC as ve,EJ as ue,G4 as A,G5 as G,G6 as me,G7 as fe,Fh as ge,hm as Se,EK as Pe,EL as ye,_ as _e,EM as E,EN as N,EO as ze,EP as R,EQ as M,Fj as we,ES as xe,ET as $e,EU as Te,EW as V,EX as be,G8 as Ve,G9 as U,Ga as I,Gb as ke,Gc as Oe,Gd as De,EY as Ce,n as p,EZ as d,hj as We,Fk as Ee,Ge as B,qR as Me,FK as Fe,l5 as Le,F2 as je,di as q,xa as Ae,eC as H,du as Y,Gf as Ge}from"./index-DNHUZoa6.js";function J(r){const e=new X,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:w}=r,u=i===2,g=i===1;e.include(Z,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
