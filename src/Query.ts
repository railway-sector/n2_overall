...
export async function generateViaductChartData(contractp: any) {
  ...
  const total_boredpile_delay = new StatisticDefinition({
  ...
  const total_pilecap_delay = new StatisticDefinition({
  ...
  const total_pier_delay = new StatisticDefinition({
  ...
  const total_pierhead_delay = new StatisticDefinition({
  ...
  const total_precast_delay = new StatisticDefinition({
